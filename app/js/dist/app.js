...
function getData(string) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, fetch('js/template.hbs')];
                case 1:
                    data = _a.sent();
                    return [4, data.text()];
                case 2:
                    ...
                    return [4, fetch(string)];
                case 3:
                    response = _a.sent();
                    return [4, response.json()];
                case 4:
                    json = _a.sent();
                    return [4, template(json)];
...
function buildQueryString(inputTitle, inputAuthor) {
    if (inputTitle === void 0) { inputTitle = ''; }
    if (inputAuthor === void 0) { inputAuthor = ''; }
...
document.querySelectorAll('form input[type=text]').forEach(function (input) {
    input.addEventListener('keyup', function (e) {
        ...
        getData(string)
            .then(function (data) {
            document.querySelector('#bookDisplay').innerHTML = data;
        });
    });
});
